...
from petstagram.main_app.views.pet_photos import show_pet_photo_details, create_pet_photo, edit_pet_photo, \
    like_pet_photo
...
urlpatterns = (
    ...
    path('profile/edint/', edit_profile, name='edit profile'),
